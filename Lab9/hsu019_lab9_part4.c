 ...
 *
 *  Demo Link: GOOGLE DRIVE https://drive.google.com/file/d/1VoANc7LLd6wx_vSU1cAy2AKLr1CtpXI7/view?usp=sharing
 */
#include <avr/io.h>
...
const unsigned long periodController = 300;
const unsigned long periodCB = 1;
...
unsigned char CO_tmpA;
enum Controller { CO_Start,CO_wait , CO_up, CO_down };
